...
star --runThreadN $THREAD --genomeDir ~/Desktop --readFilesIn $i1 --readFilesCommand gunzip -c --outFileNamePrefix $i --outSAMtype BAM SortedByCoordinate

#### (3) Further processing of BAM files ####

# Labelling of duplicated reads and removal of optical duplicates
java -jar $WKDIR/required_files/picard.jar MarkDuplicates -REMOVE_SEQUENCING_DUPLICATES true -I $ial.sortedByCoord.out.bam  -O $ial.final.bam -M $ial.bam.markdup.metrics.txt
